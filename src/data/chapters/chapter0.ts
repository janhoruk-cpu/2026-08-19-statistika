...
export const chapter0: ChapterConfig = {
  id: 'chapter-0',
  chapterNumber: 0,
  title: 'Uvod v statistiko in vizualni učbenik',
  ...
  units: [
    ...
    },
    {
      ...
      deepDive: 'Vsaka lekcija sledi jasni pedagoški strukturi:\n1. Konceptualna razlaga v razumljivem jeziku z resničnimi primeri in opozorili na tipične miselne pasti.\n2. Interaktivno platno z živo simulacijo, kjer neposredno preizkušate parametre in opazujete zakonitosti.\n3. Kratek konceptualni kviz s takojšnjo povratno informacijo za utrjevanje znanja.',
      mnemonic: {
