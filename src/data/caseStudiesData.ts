...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  {
    id: 'dual-axis-spurious-correlation',
    title: 'Past dveh Y-osi: S&P 500 in denarna masa (Navidezna vzročnost)',
    subtitle: 'Kako manipulacija dveh neodvisnih skal ustvari iluzijo popolne povezave',
    category: 'Regresija',
    chapterLink: 'unit-9-2',
    summary:
      'Finančni analitiki so leta 2016 objavili grafikon borznega indeksa S&P 500 in centralnobančne denarne mase z dvema različnima Y-osema ter trdili, da borzo neposredno poganja tiskanje denarja. Pravilna statistična analiza pa je razkrila nevarno metodološko zmoto.',
    background:
      'Indeks S&P 500 se je gibal med 700 in 2.100 točkami, medtem ko je denarna masa (Monetary Base) znašala med 1.500 in 4.100 milijardami dolarjev. Ker sta imeli spremenljivki povsem različne enote in velikostne rede, so avtorji na levi strani narisali skalo za delnice, na desni pa skalo za denar ter ju vizualno poravnali tako, da sta se črti skoraj popolnoma prekrivali.',
    dataSummary: {
      totalN: 250,
      groups: [
        { name: 'S&P 500 (leva os: 700 - 2100)', n: 250, successes: 250, rate: 'Rast v obdobju 2009–2016' },
        { name: 'Monetary Base (desna os: 1500 - 4100 mrd $)', n: 250, successes: 250, rate: 'Rast v obdobju 2009–2016' },
      ],
    },
    keyQuestion:
      'Ali dve časovni vrsti, ki se vizualno ujemata ob dveh ločenih Y-oseh, dokazujeta resnično vzročno povezavo med pojavoma?',
    interactiveExploration: {
      type: 'regression_scatter',
      description:
        'Dve časovni vrsti, ki imata obe naraščajoč trend skozi čas (avtokorelacija), imata skoraj vedno visoko navidezno korelacijo ($R^2 > 0.90$), čeprav med njima ni nobene mehanistične povezave. Z zgolj minimalnim premikom začetne točke ene osi (npr. začetek pri 0 namesto pri minimumu) se navidezno ujemanje popolnoma poruši!',
    },
    findings: [
      'Problem dveh Y-osi: Avtor grafa ima neomejeno svobodo pri izbiri začetnih in končnih točk obeh osi, kar omogoča poljubno ustvarjanje navideznih presečišč in prekrivanj.',
      'Časovna avtokorelacija: Pri časovnih serijah je vsako opazovanje močno korelirano s prejšnjim trenutkom, kar krši predpostavko o neodvisnosti napak v navadni OLS regresiji.',
      'Pravilna metodološka alternativa: Pretvorba obeh serij v indeksno število s skupnim izhodiščem ($100 = \\text{začetno leto}$) ter risanje dveh ločenih usklajenih grafov ali grafa diference.',
    ],
    takeaway:
      'Dve ločeni Y-osi na istem grafikonu sta v sodobni statistiki prepovedani: omogočata zavajanje bralca in ustvarjanje lažne korelacije med povsem nepovezanimi časovnimi serijami.',
    discussionQuestions: [
      'Zakaj je indeksiranje obeh serij na vrednost 100 v začetnem letu bistveno bolj pošteno od dveh neodvisnih navpičnih osi?',
      'Kako bi s preverjanjem stacionarnosti in diferenciranjem časovnih vrst (ARIMA modeli) odpravili lažni trend?',
    ],
  },
  {
    id: 'choropleth-population-trap',
    title: 'Past koropletnih zemljevidov: Zemljišča ne glasujejo, ljudje glasujejo',
    subtitle: 'Zakaj so geografske karte pogosto zgolj zemljevid gostote prebivalstva',
    category: 'Epidemiologija',
    chapterLink: 'unit-6-1',
    summary:
      'Ko prikažemo volilne izide ali zdravstvene kazalnike na geografskem zemljevidu ZDA ali Evrope, ogromna redko poseljena območja vizualno prevladajo nad majhnimi, a gosto poseljenimi mesti, kjer živi velika večina ljudi.',
    background:
      'Pri analizi stopnje smrti zaradi opioidov ali predsedniških volitev 2016 klasični koropletni zemljevid po okrajih obarva celotno površino države. Ker imajo zahodne zvezne države ZDA ogromne okraje z nekaj tisoč prebivalci, vzhodna velemesta pa majhne okraje z milijoni prebivalcev, gledalec podzavestno oceni večino po kvadratnih kilometrih namesto po številu ljudi.',
    dataSummary: {
      totalN: 3142,
      groups: [
        { name: 'Redko poseljeni okraji (velika površina)', n: 2100, successes: 2100, rate: '< 20 preb./km²' },
        { name: 'Gosto poseljeni urbani okraji (majhna površina)', n: 1042, successes: 1042, rate: '> 500 preb./km²' },
      ],
    },
    keyQuestion:
      'Kako pravilno vizualizirati podatke po geografskih regijah, ne da bi geografska površina popačila statistično težo prebivalcev?',
    interactiveExploration: {
      type: 'bar_compare',
      description:
        'Standardni geografski zemljevid ustvari »učinek navidezne večine«. Z uporabo ploščičnih kartogramov (*tile cartograms / statebins*), kjer ima vsaka enota enako površino ali površino sorazmerno s številom prebivalcev, se vizualno popačenje popolnoma odpravi.',
    },
    findings: [
      'Problem modifikacije prostorskih enot (MAUP): Meje okrožij in regij so administrativni konstrukti, ki nimajo enake populacijske teže.',
      'Učinek praga majhnih števil: Pri redko poseljenih okrajih lahko že 1 ali 2 dodatna dogodka ustvarita navidezno ekstremno visoko stopnjo na 100.000 prebivalcev.',
      'Sodobne vizualne rešitve: Uporaba kartogramov z enakimi ploščicami, fasetiranih časovnih trendov po regijah ali točkovnih grafov (Cleveland dotplots), razvrščenih po stopnji pojava.',
    ],
    takeaway:
      'Prostorski podatki ne zahtevajo vedno geografskega zemljevida. Pogosto je fasetiran točkovni grafikon ali kartogram bistveno bolj informativen in statistično pošten kot klasična barvna karta.',
    discussionQuestions: [
      'Zakaj je pri prikazu bolezni (npr. COVID-19 ali gripa) zemljevid brez standardizacije na število prebivalcev zgolj zemljevid mest?',
      'Kdaj je kartogram s ploščicami boljša izbira kot geografsko natančen satelitski zemljevid?',
    ],
  },
];
