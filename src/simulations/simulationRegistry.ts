...
export class SimulationManager {
  ...
  addSample(count: number = 1) {
    switch (this.currentUnitId) {
      ...
      // Poglavje 6: Kategorični podatki
      case 'unit-6-1':
        this.engine1_1.addFlip(0.5, count * 5);
        break;
      case 'unit-6-2':
        this.engine1_1.addFlip(0.4, count * 5);
        break;
      case 'unit-6-3':
      case 'unit-6-4':
        this.engine2_1.generatePoints(count * 20);
        break;

      // Poglavje 7: Številski podatki & t-test / ANOVA
      case 'unit-7-1':
        this.engine4_2.addIntervals(count * 5);
        break;
      case 'unit-7-2':
      ...
      // Poglavje 9: Logistična regresija & Modeliranje
      case 'unit-9-1':
      case 'unit-9-2':
        this.engine5_1.generatePopulation(1000);
        break;
      ...
      // Poglavje 10: Teorija ocenjevanja & Asimptotika (MLE & LRT)
      case 'unit-10-1':
        this.engine5_2.setSample(Math.min(100, this.engine5_2.k + 3), Math.min(100, this.engine5_2.n + 5));
        break;
      case 'unit-10-2':
        this.engine5_2.setTheta(Math.max(0.05, Math.min(0.95, this.engine5_2.theta + (Math.random() - 0.5) * 0.1)));
        break;
      case 'unit-10-3':
        this.engine6_1.addPoint(1 + Math.random() * 8, 1 + Math.random() * 8);
        break;

      // Poglavje 11: Ponovnovzorčenje & Ne-parametrična statistika
      case 'unit-11-1':
        this.engine4_3.addResamples(count * 50);
        break;
      case 'unit-11-2':
        this.engine1_1.addFlip(0.5, count * 5);
        break;
      case 'unit-11-3':
        this.engine6_3.shiftGroup(0, (Math.random() - 0.5) * 3);
        break;

      // Poglavje 12: Bayesovo hierarhično modeliranje & MCMC
      case 'unit-12-1':
        this.engine5_3.addCoinFlip(Math.random() < 0.6);
        break;
      case 'unit-12-2':
        this.engine5_3.addCoinFlip(Math.random() < 0.55);
        break;
      case 'unit-12-3':
        this.engine6_3.shiftGroup(1, (Math.random() - 0.5) * 3);
        break;
    }
  }
  ...
  resetCurrent() {
    ...
    switch (this.currentUnitId) {
      ...
      case 'unit-6-1': this.engine1_1.reset(); break;
      case 'unit-6-2': this.engine1_1.reset(); break;
      case 'unit-6-3':
      case 'unit-6-4': this.engine2_1.reset(); break;
      case 'unit-7-1': this.engine4_2.reset(); break;
      case 'unit-7-2': this.engine4_3.reset(); break;
      case 'unit-7-3': this.engine4_2.reset(); break;
      case 'unit-7-4': this.engine6_3.reset(); break;
      case 'unit-8-1': this.engine6_2.reset(); break;
      case 'unit-8-2':
      case 'unit-8-3':
      case 'unit-8-4': this.engine6_1.reset(); break;
      case 'unit-9-1':
      case 'unit-9-2': this.engine5_1.reset(); break;
      case 'unit-9-3': this.engine4_3.reset(); break;
      case 'unit-10-1':
      case 'unit-10-2': this.engine5_2.reset(); break;
      case 'unit-10-3': this.engine6_2.reset(); break;
      case 'unit-11-1': this.engine4_3.reset(); break;
      case 'unit-11-2': this.engine1_1.reset(); break;
      case 'unit-11-3': this.engine6_3.reset(); break;
      case 'unit-12-1':
      case 'unit-12-2': this.engine5_3.reset(); break;
      case 'unit-12-3': this.engine6_3.reset(); break;
    }
  }
  ...
  update() {
    switch (this.currentUnitId) {
      ...
      case 'unit-6-1': this.engine1_1.update(); break;
      case 'unit-6-2': this.engine1_1.update(); break;
      case 'unit-6-3':
      case 'unit-6-4': this.engine2_1.update(); break;
      case 'unit-7-1': this.engine4_2.update(); break;
      case 'unit-7-2': this.engine4_3.update(); break;
      case 'unit-7-3': this.engine4_2.update(); break;
      case 'unit-7-4': this.engine6_3.update(); break;
      case 'unit-8-1': this.engine6_2.update(); break;
      case 'unit-8-2':
      case 'unit-8-3':
      case 'unit-8-4': this.engine6_1.update(); break;
      case 'unit-9-1':
      case 'unit-9-2': this.engine5_1.update(); break;
      case 'unit-9-3': this.engine4_3.update(); break;
      case 'unit-10-1':
      case 'unit-10-2': this.engine5_2.update(); break;
      case 'unit-10-3': this.engine6_2.update(); break;
      case 'unit-11-1': this.engine4_3.update(); break;
      case 'unit-11-2': this.engine1_1.update(); break;
      case 'unit-11-3': this.engine6_3.update(); break;
      case 'unit-12-1':
      case 'unit-12-2': this.engine5_3.update(); break;
      case 'unit-12-3': this.engine6_3.update(); break;
    }
  }
  ...
  render(ctx: CanvasRenderingContext2D, width: number, height: number) {
    ...
    switch (this.currentUnitId) {
      ...
      case 'unit-6-1': this.engine1_1.render(ctx, width, height, t); break;
      case 'unit-6-2': this.engine1_1.render(ctx, width, height, t); break;
      case 'unit-6-3':
      case 'unit-6-4': this.engine2_1.render(ctx, width, height, t); break;
      case 'unit-7-1': this.engine4_2.render(ctx, width, height, t); break;
      case 'unit-7-2': this.engine4_3.render(ctx, width, height, t); break;
      case 'unit-7-3': this.engine4_2.render(ctx, width, height, t); break;
      case 'unit-7-4': this.engine6_3.render(ctx, width, height, t); break;
      case 'unit-8-1': this.engine6_2.render(ctx, width, height, t); break;
      case 'unit-8-2':
      case 'unit-8-3':
      case 'unit-8-4': this.engine6_1.render(ctx, width, height, t); break;
      case 'unit-9-1':
      case 'unit-9-2': this.engine5_1.render(ctx, width, height, t); break;
      case 'unit-9-3': this.engine4_3.render(ctx, width, height, t); break;
      case 'unit-10-1':
      case 'unit-10-2': this.engine5_2.render(ctx, width, height, t); break;
      case 'unit-10-3': this.engine6_2.render(ctx, width, height, t); break;
      case 'unit-11-1': this.engine4_3.render(ctx, width, height, t); break;
      case 'unit-11-2': this.engine1_1.render(ctx, width, height, t); break;
      case 'unit-11-3': this.engine6_3.render(ctx, width, height, t); break;
      case 'unit-12-1':
      case 'unit-12-2': this.engine5_3.render(ctx, width, height, t); break;
      case 'unit-12-3': this.engine6_3.render(ctx, width, height, t); break;
    }
  }
